...
import img1 from '../img/Hero_img1.svg'
import img2 from '../img/Hero_img2.svg'
import img3 from '../img/Hero_img3.svg'
    ...
    <div>
            <div className='w-full flex justify-center relative'>
                <div className='w-[50%] h-[50%] top-5 absolute flex justify-between z-10 '>
                    <div className='w-12 h-12 relative lg:left-16 lg:top-[30%] md:top-[30%] xs:top-[25%]'><Image src={img1} alt={img1} /></div>
                    <div className='w-12 h-12'><Image src={img2} alt={img2} /></div>
                    <div className='w-12 h-12 relative lg:right-16 lg:top-[30%] md:top-[30%] xs:top-[25%]'><Image src={img3} alt={img3}/></div>
                </div>
                ...
                <div class="w-full h-[75%] left-0 bottom-0 absolute bg-gradient-to-b bg-[#05050e] pb-10">
                        ...
                        <div>
                            ...
                            <div class="flex justify-center gap-7 mt-10 ">
                                <div class="justify-start items-start gap-10 flex">
                                    <div class="w-[165px] h-12  py-3 bg-[#00d563] rounded-lg justify-center items-center gap-2.5 flex">
                                        <div class="text-[#05050e] text-sm  font-medium ">Get Started Free</div>
                                    </div>
                                </div>
                                <div class="rounded-lg border border-[#00d563] justify-start items-start gap-10 flex">
                                    <div class="w-[165px] h-12  py-3 rounded-lg justify-center items-center gap-2.5 flex">
                                        <div class="text-[#00d563] text-sm font-medium ">Login</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className='w-full mt-40 flex justify-evenly  flex-wrap relative z-10 px-4'>
                        <div className='flex place-items-center'>  <Image className='w-[160px]' src={frame} alt={frame} /> </div>
                        <div className='flex place-items-center'>  <Image className='w-[160px]' src={frame1} alt={frame1} /> </div>
                        <div className='flex place-items-center'> <Image className='w-[160px]' src={frame2} alt={frame2} /> </div>
                        <div className='flex place-items-center'> <Image className='w-[160px]' src={frame3} alt={frame3} /> </div>
                        <div className='flex place-items-center'> <Image className='w-[160px]' src={frame4} alt={frame4} /> </div>
                        <div className='flex place-items-center'> <Image className='w-[160px]' src={frame5} alt={frame5} /> </div>
                    </div>
                </div>
            </div>
    </div>
