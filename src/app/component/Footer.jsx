            ...
            <div className='bg-[#1C2028] mt-36'>
                ...
                <div className='grid grid-cols-1 lg:grid-cols-4'>
                    ...
                    <div className='col-span-2 lg:pl-16'>
                        <div className='text-[#00d563] text-lg mb-5'>Subscription</div>
                    ...
                    <div>
                        <div className='text-[#00d563] text-lg my-5'>Info</div>
                    ...
                    <div>
                        <div className='text-[#00d563] text-lg my-5'>About us</div>
                    ...
                    <div>
                        <div className='text-[#00d563] text-lg my-5'>Contact us</div>
                        ...
                        <div><a className='hover:text-[#00d563] ' href="/">www.gitlime.com</a></div>
                    </div>
               </div>
               </div>   
            </div>
