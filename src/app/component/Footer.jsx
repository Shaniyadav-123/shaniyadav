            ...
            <div className='bg-[#1C2028] mt-36'>
                ...
                <div className='grid grid-cols-1 lg:grid-cols-4'>
                    ...
                    <div className='col-span-2 lg:pl-16'>
                        <h3 className='text-[#00d563] text-lg mb-5'>Subscription</h3>
                    ...
                    <div>
                        <h3 className='text-[#00d563] text-lg my-5'>Info</h3>
                    ...
                    <div>
                        <h3 className='text-[#00d563] text-lg my-5'>About us</h3>
                    ...
                    <div>
                        <h3 className='text-[#00d563] text-lg my-5'>Contact us</h3>
